    ...
    <header className="sticky top-0 z-50 glass border-b border-border">
      <div className="container flex h-14 items-center gap-4">
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link key={item.path} to={item.path}>
                <button className={`px-3.5 py-1.5 rounded-lg text-[13px] font-medium transition-all duration-200 relative ${
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {walletAddress && (
            <Badge variant="secondary" className="hidden md:inline-flex text-[11px] font-mono font-medium px-2.5 py-0.5 rounded-full bg-accent text-muted-foreground border-border">
          ...
          {activeRole && (
            <Badge variant="secondary" className="hidden md:inline-flex text-[11px] font-medium px-2.5 py-0.5 rounded-full bg-accent text-muted-foreground border-border">
          ...
          {user ? (
            ...
            <Link to="/login" className="hidden md:inline-flex">
              <Button size="sm" className="h-8 px-4 text-xs rounded-full font-medium">Connect Wallet</Button>
            </Link>
          )}
